            ...
            <div className="flex items-center w-full max-w-sm">
              {STEPS.map((label, i) => (
                <div key={i} className="flex items-center flex-1">
                  <div className="flex flex-col items-center">
                    <div className="w-11 h-11 rounded-full flex items-center justify-center text-sm font-bold transition-all"
                      style={i < step
                        ...
                        : i === step
                        ? { backgroundColor: '#e02424', color: 'white', boxShadow: '0 4px 12px rgba(224,36,36,0.35)' }
                  ...
                  {i < STEPS.length - 1 && (
                    <div className="flex-1 h-1 mx-3 mb-5 rounded-full transition-colors"
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input type="tel" value={form.phoneNr} onChange={e => set('phoneNr', e.target.value)}
